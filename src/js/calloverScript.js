...
function validate()
{
	...
	$.ajax({ url: "../php/updateCallover.php", method: "get", data: {ids: result}, success : function(e)
		{
		...
		$(document).ready(function()
		{
			$.ajax({url: "../php/update.php", method: "get", data: {ids: result, location: "In House", user: "Callover"},success: function(e)
			{		
				//console.log(e);	
				window.location.reload(true);
			}});
...
{
	window.location.href = "../php/newcallover.php";
}
$(document).ready(function(){
$.ajax({url: "../php/downloadCallover.php", dataType: "json", method: "get", success: function(data)
{
